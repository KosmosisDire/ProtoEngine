...
public class TextElement : Element
{
    ...
    private void Init()
    {
        DefaultStyle.fillColor = UI.GUIManager.globalTheme.textColor;
        DefaultStyle.width = new Px(() => TextBounds.Width);
        DefaultStyle.height = new Px(() => textShape.CharacterSize);
        DefaultStyle.minHeight = new Px(() => textShape.CharacterSize);
    }
    ...
    public override void BuildBox()
    {
        ...
        textShape.Font = UI.GUIManager.globalTheme.font;
